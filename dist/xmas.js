...
const SOCKET_URL = "ws://" + window.location.hostname + ":8000/xmas"
const hostIP = document.createTextNode("http://" + window.location.hostname + ":" + window.location.port + "/xmas.html")
